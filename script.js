...
// Console Easter Egg
console.log('%c👋 Olá, curioso(a)!', 'font-size: 20px; color: #64ffda; font-weight: bold;');
console.log('%cGostou do código? Vamos trabalhar juntos!', 'font-size: 14px; color: #8892b0;');
console.log('%cContato: seu.email@gmail.com', 'font-size: 12px; color: #64ffda;');
